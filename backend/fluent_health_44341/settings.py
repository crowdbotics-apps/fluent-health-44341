"""
Django settings for fluent_health_44341 project.
...
ROOT_URLCONF = 'fluent_health_44341.urls'
...
WSGI_APPLICATION = 'fluent_health_44341.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fluent_health_44341 API",
    "DESCRIPTION": "API documentation for fluent_health_44341 App",
    "VERSION": "v1",
}
